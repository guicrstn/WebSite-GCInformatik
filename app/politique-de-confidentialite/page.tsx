...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité de GC Informatik. Informations sur la collecte et le traitement de vos données personnelles.",
  robots: { index: false, follow: true },
  alternates: {
    canonical: "https://gcinformatik.fr/politique-de-confidentialite",
  },
}
